...
CREATE TABLE `room_group`  (
  ...
  `is_available` tinyint(1) NULL DEFAULT '1' COMMENT 'The group is available or not',
...
CREATE TABLE `user`  (
  ...
  `bank_account_number` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT 'Bank account number of user',
  `bank_name` varchar(255) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT 'Bank name of user',
  ...
  `is_email_verified` tinyint(1) NULL DEFAULT 0 COMMENT 'User email is verifid or not',
  `is_phone_number_verified` tinyint(1) NULL DEFAULT 0 COMMENT 'User phone number is verifid or not',
  `is_selfie_verified` tinyint(1) NULL DEFAULT 0 COMMENT 'User selfie image is verified or not',
  `is_government_id_verified` tinyint(1) NULL DEFAULT 0 COMMENT 'User government id card is verified or not',
  `is_active` tinyint(1) NULL DEFAULT 1 COMMENT 'User is active or not',
